...
import io.bootify.biblioteca.service.BibliotecarioService;
...
public class BibliotecarioResource {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<BibliotecarioDTO> getBibliotecario(@PathVariable final Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Long> updateBibliotecario(@PathVariable final Long id,
            @RequestBody @Valid final BibliotecarioDTO bibliotecarioDTO) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteBibliotecario(@PathVariable final Long id) {
