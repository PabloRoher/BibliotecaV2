...
public class LibroService {
    ...
    public String getReferencedWarning(final Long id) {
        ...
        final Prestamo libroAsociadoPrestamo = prestamoRepository.findFirstByLibroAsociado(libro);
        if (libroAsociadoPrestamo != null) {
            return WebUtils.getMessage("libro.prestamo.libroAsociado.referenced", libroAsociadoPrestamo.getIdPrestamo());
        }
        return null;
    }
